...
export class CriarTabelas1749956907896 implements MigrationInterface {
    name = 'CriarTabelas1749956907896'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "colaborador_entity" DROP COLUMN "email"`);
        await queryRunner.query(`ALTER TABLE "colaborador_entity" ADD "email" character varying NOT NULL`);
