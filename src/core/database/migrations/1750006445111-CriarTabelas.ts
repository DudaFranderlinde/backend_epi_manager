...
export class CriarTabelas1750006445111 implements MigrationInterface {
    name = 'CriarTabelas1750006445111'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "colaborador_entity" ("id" SERIAL NOT NULL, "matricula" character varying NOT NULL, "nome" character varying NOT NULL, "email" character varying NOT NULL, "cpf" character varying NOT NULL, "cargo" character varying NOT NULL, "setor" character varying NOT NULL, "lideranca" boolean NOT NULL DEFAULT false, "nome_lideranca" character varying NOT NULL, "data_cadastro" TIMESTAMP NOT NULL, "senha" character varying NOT NULL, "salt" character varying NOT NULL, "permissao" "public"."colaborador_entity_permissao_enum" NOT NULL DEFAULT 'COLABORADOR', "status_uso" "public"."colaborador_entity_status_uso_enum" NOT NULL DEFAULT 'ATIVO', CONSTRAINT "UQ_69fe679a83ba7270ae2d3f62f83" UNIQUE ("matricula"), CONSTRAINT "PK_874acf118997ba280568b184d22" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP SEQUENCE IF EXISTS equipamento_entity_codigo_seq`);
    }
