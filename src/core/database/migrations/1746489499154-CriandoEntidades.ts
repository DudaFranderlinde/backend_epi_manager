...
export class CriandoEntidades1746489499154 implements MigrationInterface {
    name = 'CriandoEntidades1746489499154'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "equipamento" ("id" SERIAL NOT NULL, "codigo" character varying NOT NULL, "descricao" character varying NOT NULL, "preco" integer NOT NULL, "dataValidade" TIMESTAMP, "ca" character varying, CONSTRAINT "PK_acf3348d50642a66234d79b0e6b" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "estoque" ADD CONSTRAINT "FK_f831d1785adf90f53c9080e1bcc" FOREIGN KEY ("equipamentoId") REFERENCES "equipamento"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "historico_entrada_saida" ADD CONSTRAINT "FK_1c166f6ac6f602a67be2f2eaca6" FOREIGN KEY ("equipamentoId") REFERENCES "equipamento"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "solicitacao_entity" ADD CONSTRAINT "FK_0046a2db02858c78e3682a1c8a0" FOREIGN KEY ("equipamentoId") REFERENCES "equipamento"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
